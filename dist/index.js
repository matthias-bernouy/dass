...
// src/resources/generated/ts/server.raw.ts
...
// src/resources/generated/ts/ffi_methods.raw.ts
...
// src/resources/generated/ts/endpoint/endpoint.raw.ts
...
// src/resources/generated/c/C_DOCUMENT_TEMPLATE.c
...
var library_dir = import.meta.dir;
var resources_dir = join(library_dir, "src/", "resources");

// src/core/application/ApplicationPaths.ts
import { join as join2 } from "path";
function get_dass_generated_dir_source() {
  return join2(library_dir, "src", "resources", "generated");
}
...
function generate_structure() {
  cpSync(join4(resources_dir, "c"), join4(code_generated_dir(), "c"), { recursive: true });
...
class Application {
  ...
  static async build() {
    ...
    Application.stop = module.AppRunner();
  }
}
...
// src/core/hooks/register_hook.ts
function register_hook(hook, target, cb) {
  ApplicationObjects.register_hook(new Hook({
    type: hook,
    target,
    cb
  }));
